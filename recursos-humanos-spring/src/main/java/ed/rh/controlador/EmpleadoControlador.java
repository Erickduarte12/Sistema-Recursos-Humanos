package ed.rh.controlador;
import ed.rh.excepcion.RecursoNoEncontradoExcepcion;
import ed.rh.modelo.Empleado;
import ed.rh.servicio.IEmpleadoServicio;
...
public class EmpleadoControlador {
    ...
    public Empleado agregarEmpleasdo(@RequestBody Empleado empleado){
